...
add wave -noupdate -format Analog-Step -height 84 -max 8388610.0 -min -8388610.0 -radix decimal /sc_main/dsp_unit_top_inst/dsp_unit_inst/abuf_in[1]
add wave -noupdate -format Analog-Step -height 84 -max 8388610.0 -min -8388610.0 -radix decimal /sc_main/dsp_unit_top_inst/dsp_unit_inst/abuf_in[0]
add wave -noupdate -format Analog-Step -height 84 -max 8388610.0 -min -8388610.0 -radix decimal /sc_main/dsp_unit_top_inst/dsp_unit_inst/dsp_out[1]
add wave -noupdate -format Analog-Step -height 84 -max 8388610.0 -min -8388610.0 -radix decimal /sc_main/dsp_unit_top_inst/dsp_unit_inst/dsp_out[0]
