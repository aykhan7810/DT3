...
add wave -noupdate -expand -group {PLAYBACK CONTROL} /sc_main/tlm_top_inst/tlm_audioport_inst/abuf_read_counter

add wave -noupdate -group {PLAYBACK CONTROL} -childformat {{/sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(0) -radix decimal -childformat {{/sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(0).left -radix decimal} {/sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(0).right -radix decimal}}} {/sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(1) -radix decimal} {/sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(2) -radix decimal} {/sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(3) -radix decimal}} -subitemconfig {/sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(0) {-radix decimal -childformat {{/sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(0).left -radix decimal} {/sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(0).right -radix decimal}}} /sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(0).left {-radix decimal} /sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(0).right {-radix decimal} /sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(1) {-radix decimal} /sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(2) {-radix decimal} /sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo(3) {-radix decimal}} /sc_main/tlm_top_inst/tlm_audioport_inst/buffer_fifo
add wave -noupdate -expand -group {PLAYBACK CONTROL} /sc_main/tlm_top_inst/tlm_audioport_inst/irq_out
