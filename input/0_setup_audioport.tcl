...
#####################################################################################
# SystemC code settings for mixedlang simulation
#####################################################################################
...
set SYSTEMC_MODULES         { control_unit dsp_unit cdc_unit i2s_unit }
...
if { $UVM_TESTBENCH == 1 } {
    ...
    set VSIM_RTL_WAVES             "input/3_vsim_audioport_rtl_simulation_waves_simple.tcl"
    set VSIM_MIXEDLANG_WAVES       "input/3_vsim_audioport_rtl_simulation_waves_simple.tcl"
}
...
set POSTLAYOUT_SIMULATION_TIME  50us
# VCD dump start time and length for power simulation
set VCD_SNAPSHOT_START_TIME     1us
