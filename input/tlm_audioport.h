...
SC_MODULE(tlm_audioport) 
{
  ...
  sc_bigint < 32+24+FILTER_TAPS >    accu30L, accu330L, accu30R, accu330R;
  sc_bigint < 32+24+FILTER_TAPS+1 >  sumL, sumR;	   
  sc_int < 17 >     levelL;
  sc_int < 17 >     levelR;
  sc_int < 42 >     scaledL;
  sc_int < 42 >     scaledR;
  ...
  sc_int < 24 >     dsp_outputs[2];      
   ...
   sc_fifo < audio_data_t >   buffer_fifo;
